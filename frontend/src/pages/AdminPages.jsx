...
export function Dashboard() {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-r from-teal-500 to-blue-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-2xl font-bold mb-2 flex items-center gap-2">Lab-ready flows</h2>
          <p className="opacity-90 max-w-2xl">Use the visible screens for GUI checks, input validation, OTP expiry, business-rule testing and unit-test evidence.</p>
        </div>
...
export function RoomsPage() {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start animate-in fade-in duration-500">
...
// ... tenants, contracts, etc. can be similarly updated in AdminPages.jsx
...
export function RevenuePage() {
  ...
  useEffect(()=>{load()},[])
  return (
    <div className="max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm animate-in fade-in duration-500">
